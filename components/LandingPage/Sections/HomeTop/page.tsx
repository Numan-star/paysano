...
const HomeTop = ({ HEADER, HEADER_DESCRIPTION, checkButton }: HeaderProps) => {
      ...
      <div className='px-10 lg:px-0 mx-auto w-full'>
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between justify-center items-center pt-20">
          ...
          <div className='max-w-[900px] flex flex-col gap-5 my-20 lg:my-10 lg:p-10 text-center lg:text-left  '>
            {/* text div */}
            <div>
              <h2 className="font-bold text-[30px] lg:text-[70.42px] mb-3" dangerouslySetInnerHTML={{ __html: HEADER }}>
              </h2>
              <p className="text-[15px] lg:text-[20px] font-semibold text-black-50 "> {HEADER_DESCRIPTION}</p>
            </div>
